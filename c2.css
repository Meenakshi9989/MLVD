.u-section-1 {
    background-image: linear-gradient(0deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), url("https://assets.nicepagecdn.com/ffd9178e/6055139/images/26213342-0.jpeg");
  ...
  .u-section-1 .u-text-2 {
    font-size: 1.875rem;
    letter-spacing: 1px;
    text-shadow: 0px 0px 22px rgba(0,0,0,0.35);
    box-shadow: 0px 0px 0 0 rgba(0,0,0,0);
    width: 783px;
  ...
  @media (max-width: 575px) {
    ...
    background-image: url("//images01.nicepagecdn.com/c461c07a441a5d220e8feb1a/b01f1f1be80954858db0a36a/-min.jpg");
    background-position: 50% 50%;
  }
